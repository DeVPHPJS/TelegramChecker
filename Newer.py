...
if cho == '1'or cho =='01':
    while True:
        ...
        if 'tgme_username_link' in url:
            requests.get(f'https://api.telegram.org/bot{tok}/sendMessage?chat_id={ID}&text=تم صـيد مـن قبل قــــــدآوُي †. : @{user}\n• ──────⚜────── • \n👑𝑷𝒊𝒐𝒖𝒔 :  " @BBIBIEB " ')
...
if cho == '4'or cho =='04':
    while True:
        ...
        url = requests.get(f'https://t.me/{user}').text
        if 'tgme_username_link' in url:
            requests.get(f'https://api.telegram.org/  bot{tok}/sendMessage?chat_id={ID}&text=@BBIBIEB : @{user}\n• ──────⚜────── • \n👑𝑷𝒊𝒐𝒖𝒔 :  " @BBIBIEB " ')
            print(f' \033[1;32m {user}')
        else:
            print(f' \033[1;31m NOT AVAILABLE : {user}')
if cho == '5'or cho =='05':
...
'opt_into_one_tap': 'false'
        ...
        if Uss in uS:
            requests.get(f'https://api.telegram.org/   bot{tok}/sendMessage?chat_id={ID}&text=𝑷𝒊𝒐𝒖𝒔 : @{user}\n• ──────⚜────── • \n👑𝑷𝒊𝒐𝒖𝒔 :  " @BBIBIEB " ')
            print(f' \033[1;32m {user}')
        else:
            time.sleep(1)
            print(f' \033[1;31m NOT AVAILABLE : {user}')
